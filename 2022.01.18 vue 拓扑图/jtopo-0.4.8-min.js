...
! function(window) {
        ...
        function c(c) {
            ...
            q.forEach(function(a) {
                ...
                function() {
                    ...
                    0 == n.frames ? time24 = setTimeout(arguments.callee, 100) : n.frames < 0 ? (n.repaint(), time24 = setTimeout(arguments.callee, 1e3 / -n.frames)) : (n.repaint(), time24 = setTimeout(arguments.callee, 1e3 / n.frames))
                }(), setTimeout(function() {
    ...
    function(a) {
        function b(c) {
            ...
            this.initialize = function() {
                ...
                //实现拓扑图 整体无法拖动 stage.tuodon为自定义属性，用于区别其他页面
                if ((this.currentElement == null || this.currentElement.elementType=="link") && (null!=this.stage.tuodon && undefined!=this.stage.tuodon) ){return;}
                var c = this.toSceneEvent(b);
    ...
    function(a) {
        function b() {
            this.initialize = function() {
                b.prototype.initialize.apply(this, arguments), this.elementType = "displayElement", this.x = 0, this.y = 0, this.width = 32, this.height = 32, this.warningImg, this.visible = !0, this.alpha = 1, this.rotate = 0, this.scaleX = 1, this.scaleY = 1, this.strokeColor = "22,124,255", this.borderColor = "22,124,255", this.fillColor = "22,124,255", this.shadow = !1, this.shadowBlur = 5, this.shadowColor = "rgba(0,0,0,0.5)", this.shadowOffsetX = 3, this.shadowOffsetY = 6, this.transformAble = !1, this.zIndex = 0;
                var a = "x,y,width,height,warningImg,visible,alpha,rotate,scaleX,scaleY,strokeColor,fillColor,shadow,shadowColor,shadowOffsetX,shadowOffsetY,transformAble,zIndex,warningImg".split(",");
    ...
    function(a) {
        function b(c) {
            this.initialize = function(c) {
                ...
                if (this.image) {
                    ...
                    this.width = 70;
                    this.height = 61;
                    a.globalAlpha = this.alpha, null != this.image && null != this.alarm ? a.drawImage(this.image, -this.width / 2, -this.height / 2, this.width, this.height) : a.drawImage(this.image, -this.width / 2, -this.height / 2, this.width, this.height), a.globalAlpha = b
                } else{
                    if(null!=this.assetPage && this.assetPage){
                        nodeAssetCri(a, this);
                    }else {
                ...
                if (null != this.alarm && "" != this.alarm) {
                    try {
                        ...
                        a.drawImage(this.warningImg, 30, -30, 25, 25);
                        a.globalAlpha = b
                    }catch(error){}

                    /*if(null!=this.warningImg && ""!=this.warningImg){
                        let xZhou = this.x;
                        let yZhou = this.y;
                        console.log("xZhou:")
                        a.drawImage(this.warningImg , xZhou + 100, yZhou + 10, 32, 32);
                    }*/
                    /*
                    var b = this.alarmColor || "255,255,0",
                        c = this.alarmAlpha || .5;
                ...
                if(null!=this.text && undefined!=this.text && ""!=this.text){
                    ...
                    for(var i=0;i<textArr.length;i++) {
                        ...
                        if (null != b && "" != b) {
                            ...
                            a.fillText(b, e.x, e.y + i*20), a.closePath(),a.restore();
                        }
                    }
                }
                if( null!=this.assetPage && this.assetPage){
            ...
            }, this.setWarningImage = function(b) {
                var d = this;
                if ("string" == typeof b) {
                    var e = j[b];
                    if(null==e){
        ...
        function f(a) {
            this.initialize(arguments), this._radius = 20, this.beginDegree = 0, this.endDegree = 2 * Math.PI, this.text = a, this.paint = function(a) {
                ...
                a.save(), a.beginPath(), a.strokeStyle = "rgba(168,202,255, 0.1)", a.fillStyle = "rgba(168,202,236,0.1)", a.arc(0, 0, this.radius + 3, this.beginDegree, this.endDegree, !0), a.fill(), a.stroke(), a.closePath(), a.restore()
            }
        }
    ...
    function(a) {
        ...
        function f(b, c, g) {
            ...
            this.initialize = function(b, c, d) {
            ...
            }, this.setAssetLinkImage1 = function(b) {
                var d = this;
                if ("string" == typeof b) {
                    var j = {};
                    var e = j[b];
                    if(null==e){
                        ...
                        this.assetLinkImage1 = e
                    }
                } else{
                    this.assetLinkImage1 = b
                }
            }, this.setAssetLinkImage2 = function(b) {
                var d = this;
                if ("string" == typeof b) {
                    var j = {};
                    var e = j[b];
                    if(null==e){
                        ...
                        this.assetLinkImage2 = e
                    }
                } else{
                    this.assetLinkImage2 = b
                }
                ...
                if(null!=this.assetLink){
                    if(this.assetLink){
                        maichongMet(this, a, b[b.length - 2], b[b.length - 1 ]);
                    }else{
                        maichongMet(this, a, b[b.length - 1], b[b.length - 2 ]);
                    }
                }
                if(this.dashedPattern==5){
                    //自定义添加代码
                    if(null!=this.isWarningNum){
                        if(this.isWarningNum==1){
                            maichongMet(this, a, b[b.length - 2], b[b.length - 1 ]);
                        }else if(this.isWarningNum==-1){
                            maichongMet(this, a, b[b.length - 1], b[b.length - 2]);
                        }else if(this.isWarningNum==2){
                            if(null!=this.eastDirection){
                                if(this.eastDirection){
                                    maichongMet(this, a, b[b.length - 2], b[b.length - 1 ]);
                                }else{
                                    maichongMet(this, a, b[b.length - 1], b[b.length - 2]);
                                }
 ...
 * @param a
 * @param len 两点之间的距离
 * @param k 如果是反向的k为-1 正向1
 * **/
function run_pulse(line, a, len, k, max_len, imgUrl){
    //绘制动态脉冲效果
    try {
        let time = 0;
        if (line.time) {
        ...
        time += 0.2;
        if (10 + (time * time) > len || len >= max_len) {
            time = 0
            if(null!=line.eastDirection){
                line.eastDirection = !line.eastDirection;
            }
            if(null!=line.assetLink){
                line.assetLink = !line.assetLink;
            }
        }
        line.time = time
        x = 10 + time * time;//位移公式带入
        if(null!=line.assetLink){
            a.drawImage(imgUrl, x * k, -5, 46, 10);
        }else{
            a.drawImage(imgUrl, x * k, -5, 20, 9);
        }

        a.moveTo(x * k, 0)
        a.fillStyle = "#F00"
        a.strokeStyle = "rgb(79,170,238)"
        a.lineWidth = 2;
 ...
 * @param b 第一个节点的坐标
 * @param c第二个节点的坐标
 * @param max_len 最长连线，用于二次折线是否吃药重新计时
 * **/
function Draw_Twopoint_pilse(context, a, b, c, max_len){
    try {
        let len = Math.sqrt(Math.pow(b.x - c.x, 2) + Math.pow(b.y - c.y, 2));
        let angle = Math.atan((b.y - c.y) / (b.x - c.x));
        let angle1 = Math.atan2((b.y - c.y), (b.x - c.x));
        a.save();
        a.beginPath();
        a.moveTo(b.x, b.y)
        a.translate(b.x, b.y)
        ...
        let num = angle1 * 2 / Math.PI;
        let imgUrl = fangxaing(context, num )
        if (num > 1 || num < -1) {
            run_pulse(context, a, len, 1, max_len, imgUrl)
        } else {
            run_pulse(context, a, len, -1, max_len, imgUrl)
        }
    }catch(error){}
...
function fangxaing(context, num ){
    if( null!=context.assetLink ){
        if(Math.abs(num)>=1){
            return context.assetLinkImage1;
        }else{
            return context.assetLinkImage2;
        }
    }
    if(null!=context.isWarningNum){
        if(context.isWarningNum==-1){
            if(Math.abs(num)>=1){
                return context.linkImg;
            }else{
                return context.linkImg2;
            }
        }else if(context.isWarningNum==1){
            if(Math.abs(num)>=1){
                return context.linkImg;
            }else{
                return context.linkImg2;
            }
        }else if(context.isWarningNum==2){
            if(null!=context.eastDirection){
                if(Math.abs(num)>=1){
                    return context.linkImg;
                }else{
                    return context.linkImg2;
...
function maichongMet(_this,a,c,d){
    let len1;
    try{
        len1 = Math.sqrt(Math.pow(c.x - d.x,2)) + Math.pow(c.y - d.y,2)
    }catch(error){
        len1 = 0
    }
    Draw_Twopoint_pilse(_this, a, c, d, len1)
}
//--------------脉冲部分代码---end
 ...
 * 圆角背景
 * **/
function strokeRoundRectBackground(cxt, x, y, width, height, radius, /*optional*/ fillColor){
    strokeRoundRect(cxt, x - 1, y - 1, width + 2, height + 2, radius, "rgba(33,116,174,1)");//边框颜色
    fillRoundRect(cxt, x, y, width, height, radius, "rgba(0,16,57,.5)");//背景填充
}
/**该方法用来绘制圆角矩形
...
function strokeRoundRect(cxt, x, y, width, height, radius, /*optional*/ lineWidth, /*optional*/ strokeColor) {
    ...
    cxt.strokeStyle = strokeColor || "#2174ae";
    cxt.stroke();
    cxt.restore();
}
 ...
 * _this 当前节点参数
 * **/
let assetColorObj = ['18,10,251,1', '67,255,53,1', '255,252,0,1', '255,102,0,1', '255,0,2,1'];
function nodeNamePage(a, _this){
    let level = null==_this.level?1:_this.level;
    //节点标题
    let title = _this.assetName;
    if (null != title && "" != title) {
        a.save(),a.beginPath(), a.font = "700 16px/24px 宋体";
        var c = a.measureText(title).width,
            d = a.measureText("田").width;
        a.fillStyle = "rgba(255,255,255, 1)";
        var e = _this.getTextPostion(_this.textPosition, c, d);
        a.fillText(title, e.x, e.y - 150), a.closePath(),a.restore();
    }
    let riskScore = _this.riskScore;
    if (null != riskScore && "" != riskScore) {
        a.save(),a.beginPath(), a.font = "700 16px/24px 宋体";
        var c = a.measureText(riskScore).width,
            d = a.measureText("田").width;
        a.fillStyle =  "rgba(" +assetColorObj[level-1]+ ")";
        var e = _this.getTextPostion(_this.textPosition, c, d);
        a.fillText(riskScore, e.x - 30, e.y - 120), a.closePath(),a.restore();
    }
    let riskLevel = _this.riskLevel;
    if (null != riskLevel && "" != riskLevel) {
        a.save(),a.beginPath(), a.font = "700 16px/24px 宋体";
        var c = a.measureText(riskLevel).width,
            d = a.measureText("田").width;
        a.fillStyle = "rgba(" +assetColorObj[level-1]+ ")";
        var e = _this.getTextPostion(_this.textPosition, c, d);
        a.fillText(riskLevel, e.x + 30, e.y - 120), a.closePath(),a.restore();
    }
}
 ...
 * 资产地图的波纹效果
 * **/
function nodeAssetCri(a, _this){
    let level = _this.level;
    a.beginPath();
    a.fillStyle = "rgba(" +assetColorObj[level-1]+ ")";
    a.arc(0,0,11,0,2*Math.PI); //a.arc(x,y,r,sAngle,eAngle,counterclockwise); 圆的中心的 x 坐标。 圆的中心的 y 坐标。圆的半径。起始角，以弧度计。（弧的圆形的三点钟位置是 0 度）。结束角，以弧度计。
    a.fill();
    a.closePath();

    nodeAssetCircle(a, _this);
}
 ...
 * **/
let criTime = 0;
let assetColorObj2 = ['18,10,251', '67,255,53', '255,252,0', '255,102,0', '255,0,2'];
function nodeAssetCircle(a, _this){
    let alpha = 1;
    let alphaAdue = 0;
    let level = _this.level;
    let width = (null==_this.width || undefined==_this.width)?150:_this.width;
    criTime += 0.04;
    let cryR = 11+ (criTime * criTime);
    if (cryR >= width ) {
        criTime = 0;
        cryR = 11;
    }
    alphaAdue = cryR/width;
    a.save();
    a.strokeStyle = "rgba(" +assetColorObj2[level-1]+ ","+ (alpha - alphaAdue)+")";
    a.lineWidth = 2;
    a.lineCap = "round";
    a.shadowBlur=5;
    a.shadowColor=a.strokeStyle;
    a.beginPath();
    a.arc(0,0,cryR/2,0,2*Math.PI);//a.arc(x,y,r,sAngle,eAngle,counterclockwise); 圆的中心的 x 坐标。 圆的中心的 y 坐标。圆的半径。起始角，以弧度计。（弧的圆形的三点钟位置是 0 度）。结束角，以弧度计。
    a.stroke();
    a.closePath();
    a.restore();
}